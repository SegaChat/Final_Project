...
def count_gpt_tokens(messages):
    ...
    try:
        ...
        logging.error(f"Ошибка в функции count_gpt_tokens: {e}")  # Уточнение имени функции
        return 0
...
def ask_gpt(messages):
    ...
    try:
        ...
        logging.error(f"Ошибка в функции ask_gpt: {e}")  # Уточнение имени функции
        return False, f"Ошибка при обращении к GPT: {str(e)}", None
